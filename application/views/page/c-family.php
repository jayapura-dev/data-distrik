        ...
        <form method="post" class="ui form" action="<?php echo base_url()?>Penduduk/save_family">
            ...
            <div class="field">
                ...
                <div class="three fields">
                    <div class="field">
                        ...
                        <input type="text" name="nama_kk" placeholder="Nama Lengkap Kepala Keluarga">  
                    </div>
                    <div class="field">
                        <input type="text" name="nomor_kartu_keluarga" placeholder="Nomor Kartu Keluarga">
                    </div>
                    <div class="Kampung">
            ...
            <div class="field">
                ...
                <div class="fields">
                    ...
                    <div class="six wide field">
                        <input type="text" name="rt" placeholder="RT, diisi dengan angka (Contoh : 001)">
                    </div>
                    <div class="six wide field">
                        <input type="text" name="rw" placeholder="RW, diisi dengan angka (Contoh : 001)">
                    </div>
                </div>
            </div>
            <br />
                ...
                <div class="fields">
                    ...
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="status_lahan">
                            <option value="Milik Sendiri">Status Lahan</option>
                        </select>
                    </div>
                </div>
            </div>
