        ...
        <form method="post" class="ui form" action="<?php echo base_url()?>Penduduk/sava_family_edit">
            ...
            <div class="field">
                ...
                <div class="three fields">
                    <div class="field">
                        ...
                        <input type="text" name="nama_kk" value="<?php echo $fam['nama_kk'] ?>" placeholder="Nama Lengkap Kepala Keluarga">  
                    </div>
                    <div class="field">
                        <input type="text" name="nomor_kartu_keluarga" value="<?php echo $fam['nomor_kartu_keluarga'] ?>" placeholder="Nomor Kartu Keluarga">
                    </div>
                    <div class="Kampung">
                        <select class="ui fluid dropdown" name="id_kampung">
            ...
            <div class="field">
                ...
                <div class="fields">
                    ...
                    <div class="six wide field">
                        <input type="text" name="rt" value="<?php echo $fam['rt'] ?>" placeholder="RT, diisi dengan angka (Contoh : 001)">
                    </div>
                    <div class="six wide field">
                        <input type="text" name="rw" value="<?php echo $fam['rw'] ?>" placeholder="RW, diisi dengan angka (Contoh : 001)">
                    </div>
                </div>
            </div>
            <br />
            <div class="field">
                ...
                <div class="fields">
                    ...
                    <div class="four wide field">
                        <input type="text" name="nomor_telfon" value="<?php echo $fam['nomor_telfon'] ?>" placeholder="Nomor Telfon">
                    </div>
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="penguasaan_bangunan">
                    ...
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="status_lahan">
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="six wide field">
                        <input type="text" name="luas_lantai" value="<?php echo $fam['luas_lantai'] ?>" placeholder="Luas Lantai (Dalam Satuan m2)">
                    </div>
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="jenis_lantai">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="kondisi_lantai">
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="jenis_dinding">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="kondisi_dinding">
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="jenis_atap">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="kondisi_atap">
                    ...
                    <div class="four wide field">
                        <input type="number" name="jumlah_kamar" value="<?php echo $fam['jumlah_kamar'] ?>" placeholder="Jumlah Kamar">
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="sumber_air_minum">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="peroleh_air_minum">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="ketersediaan_air">
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="sumber_penerangan">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="daya_pln">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="energi_memasak">
            ...
            <div class="field">
                ...
                <div class="fields">
                    <div class="four wide field">
                        <select class="ui fluid dropdown" name="fasilitas_buang_air">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="penggunaan_jamban">
                    ...
                    <div class="six wide field">
                        <select class="ui fluid dropdown" name="pembuangan_air">
